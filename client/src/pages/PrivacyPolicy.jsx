...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 pt-20 sm:pt-28 pb-16">
      <div className="container mx-auto px-4 sm:px-6 max-w-3xl">
        ...
        {/* Hero Header */}
        <div className="bg-gradient-to-r from-purple-600 to-purple-700 rounded-2xl p-8 mb-8 text-white relative overflow-hidden">
        ...
        <div className="mt-6 flex justify-center gap-6">
          <Link to="/terms-of-services" className="text-sm text-purple-600 hover:underline">Terms of Service</Link>
