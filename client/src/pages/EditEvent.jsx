      ...
      <div className="container mx-auto px-4">
        ...
        <form onSubmit={handleSubmit}>
            ...
            {ticketTypes.map((ticket, index) => (
              <div key={index} className="grid md:grid-cols-4 gap-4 mb-3">
                ...
                <div>
                  ...
                  <div className="px-4 py-2 bg-gray-100 border-2 border-gray-200 rounded-xl text-gray-700 font-semibold flex items-center">
                    {ticket.sold}
                  </div>
                </div>
              </div>
          ...
          <div className="flex gap-4">
            <button
              type="submit"
              className="flex-1 bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-4 rounded-xl hover:from-purple-700 hover:to-indigo-700 font-bold text-lg transition-colors"
            >
              ✨ Update Event
            </button>
            <button
