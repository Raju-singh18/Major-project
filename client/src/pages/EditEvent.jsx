      ...
      <div className="min-h-screen pt-20 sm:pt-20 sm:pt-28 pb-8 sm:pb-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-white border border-gray-200 rounded-2xl p-8">
            <h1 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-900">Edit Event</h1>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                ...
                {ticketTypes.map((ticket, index) => (
                  <div key={index} className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-3">
                    <div>
              ...
              <div className="flex gap-4">
                <button type="submit" disabled={submitting}
                  className="flex-1 bg-purple-600 text-white py-4 rounded-xl hover:bg-purple-700 font-bold text-lg transition-colors disabled:opacity-50 flex items-center justify-center gap-2">
                  {submitting
